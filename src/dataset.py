...
class RetailDataset:
    def __init__(self, file_path: pathlib.Path, thres_sec: int) -> None:
        ...
        self.product_master = self.product_master.rename(columns={'jan_code':"JAN"})
        ...
        self.display_action: pd.DataFrame = pd.read_pickle(file_path / "display_action_id.pkl")
    ...
    def get_display_action2name(self):
        display_action_names = self.display_action['display_name'] + '_' + self.display_action['action_name']
